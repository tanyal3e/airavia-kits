...
declare const __VLS_base: DefineComponent<RootProps, {
    openMenu: () => void;
    closeMenu: () => void;
    selectDate: () => void;
    clearValue: () => void;
    ...
    executeFlow: (step?: PickerSection) => void;
    toggleMenu: () => void;
    dpMenuRef: () => any;
    dpWrapMenuRef: () => Readonly< ShallowRef<HTMLDivElement | null, HTMLDivElement | null>>;
    inputRef: () => any;
    ...
    closed: () => any;
    cleared: () => any;
    "flow-step": (step: PickerSection) => any;
    ...
    "menu-mounted": (el: HTMLElement) => any;
    "menu-unmounted": (el: HTMLElement) => any;
    ...
    "onFlow-step"?: ((step: PickerSection) => any) | undefined;
    ...
    "onMenu-mounted"?: ((el: HTMLElement) => any) | undefined;
    "onMenu-unmounted"?: ((el: HTMLElement) => any) | undefined;
}>, {
    timePicker: boolean;
    dark: boolean;
...
declare type __VLS_Slots = RootSlots;
...
export declare interface DatePickerMonthYearSlotProps {
    mode: 'date';
    month: number;
    year: number;
    months: SelectItem[];
...
export declare interface DatePickerSidebarSlotProps {
    modelValue: InternalModelValue;
...
export declare interface MonthPickerMonthYearSlotProps {
    mode: 'month';
...
export declare interface MonthPickerSidebarSlotProps {
    modelValue: InternalModelValue;
    year: ComputedRef<(instance: number) => number>;
    getModelMonthYear?: () => {
        month: number | null;
...
export declare interface QuarterPickerSidebarSlotProps {
    modelValue: InternalModelValue;
    year: ComputedRef<(instance: number) => number>;
...
export declare interface TimePickerSidebarSlotProps {
    modelValue: InternalModelValue;
    time: InternalTime;
    updateTime: (time: TimeInternalModel) => void;
}
...
export declare const VueDatePicker: typeof __VLS_export;
...
export declare interface YearPickerMonthYearSlotProps {
    mode: 'year';
    years: OverlayGridItem[][];
    selectYear: (year: number, instance: number) => void;
}

export declare interface YearPickerSidebarSlotProps {
    modelValue: InternalModelValue;
