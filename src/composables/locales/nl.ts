...
export const nl: Strings = {
  ...
  premium_lounge_cta: "Ontdek Lounges",
  ...
  premium_corp_cta: "Ontdek Programma's",
  dest_label: "Ons Netwerk",
  dest_title: "Langeafstandsroutes",
  dest_subtitle: "Vlieg direct naar de grote zakelijke hubs ter wereld.",
